    ...
    try:
        for key in srcObj:
            ...
            if value == "[Value]":
                ...
                valueTxt = f"`{ukkoUtils.asJsonStr(srcObj[key])}`"
            else:
                valueTxt = str(value)
...
class IMarkdownElement:
    ...
    def reviewCreateOrGetCachedForLogging(
        ...
        # |ExtraLogging| _txt=ukkoUtils.asJsonStr(elementOut, indent=2)
    ...
    def __init__(self, spec: Spec):
        ...
        _txt = ukkoUtils.asJsonStr(self, indent=2)
...
class MarkdownTable(IMarkdownElement):
    ...
    def _asStr(self, cell: Any) -> str:
        if cell is None:
            ...
            return ukkoUtils.asJsonStr(cell)
